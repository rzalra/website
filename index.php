...
<html lang="en">
  ...
  <body>
    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="logoudinus.png" class="img-fluid" width="300" />
          <div>
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="foto10.jpeg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="foto15.jpeg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="foto13.jpeg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="foto14.jpeg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
          ...
          <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
            ...
            <div class="col">
              <div class="card h-100">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    Basis Data<br />14.10-15.50 | H.5.14
                  </li>
                  <li class="list-group-item">
            ...
            <div class="col">
              <div class="card h-100">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    Probabilitas Dan Statistik<br />09.30-12.00 | H.4.12
                  </li>
                  <li class="list-group-item">
                   Logika Informatika<br />12.30-15.00 | H.4.5
                  </li>
                  <li class="list-group-item">
                    Sistem Operasi<br />15.30-18.00 | H.4.10
                   </li>
                </ul>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    Sistem Informasi<br />09.30-12.00 | H.4.6
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="container">
          <div class="d-sm-flex align-items-center justify-content-center">
            ...
            <div class="p-md-5 text-sm-start">
              <h3 class="lead">A11.2023.14912</h3>
              <h1 class="fw-bold">Rizal Nugrahanto</h1>
    ...
    <footer id="footer" class="text-center p-5">
        <div>
          <a href="https://www.instagram.com/rzalra"
            ><i class="bi bi-instagram h2 p-2"></i
          ></a>
          <a href="https://twitter.com/udinusofficial"
            ><i class="bi bi-twitter h2 p-2"></i
          ></a>
          <a href="https://wa.me/+628232262526"
            ><i class="bi bi-whatsapp h2 p-2"></i
          ></a>
        </div>
        <div>Rizal Nugrahanto &copy; 2024</div>
    </footer>
    <!-- footer end -->
